	...
	<div class="row">
		<div class="col-lg-6">
			...
			<?php foreach ($buku as $b) { ?>
				<form action="<?= base_url('buku/ubahBuku'); ?>" method="post" enctype="multipart/formdata">
						...
						if (isset($b['image'])) { ?>
							...
							<picture>
								<source srcset="" type="image/svg+xml">
									<img src="<?= base_url('assets/img/upload/') . $b['image']; ?>" class="rounded mxauto mb-3 d-blok" alt="...">
								</picture>
							<?php } ?>
